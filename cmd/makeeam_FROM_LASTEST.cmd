...
"C:\Program Files\7-Zip\7z.exe" a "%destpath%\%addon1%_%wowversion%_%MYDATE%_%MYTIME%.zip" "%srcpath1%" -x!.*
"C:\Program Files\7-Zip\7z.exe" a "%destpath%\%addon1%_%wowversion%_%MYDATE%_%MYTIME%.zip" "%srcpath2%" -x!.*
explorer "%destpath%"
pause