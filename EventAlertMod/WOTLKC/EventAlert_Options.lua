...
function EAFun_GroupEvent_LoadGroupEventToFrame(GroupID)
	...
	if (GroupID <= #EA_GrpItems[EA_playerClass]) then
		G.GroupItems = EA_GrpItems[EA_playerClass][GroupID]
	...
	EA_GroupEventSetting_Frame_LocX:SetText(G.GroupItems.LocX)
	EA_GroupEventSetting_Frame_LocY:SetText(G.GroupItems.LocY)
...
function EAFun_GroupEvent_SaveFrameToGroupEvent()
	...
	-- and then save G.GroupItems to EA_GrpItems[EA_playerClass][GroupID]
	local ipairs = ipairs
...
function G:Options_AlertSoundSelect_OnLoad()	
	UIDropDownMenu_Initialize(EA_Options_Frame_AlertSoundSelect, G.AlertSoundSelect_Initialize)	
...
-----------------------------------------------------
function G:Options_AlertSoundSelect_OnClick(self)
	local SelValue = self.value
