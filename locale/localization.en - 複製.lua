...
EA_TTIP_SPECFLAG_CHECK_ESSENCE = "Show Essence in the left 1st position of Self-Buffs"				--  Support Evoker's Essence
...
EA_XOPT_SPECFLAG_ESSENCE = EA_XSPECINFO_ESSENCE
...
EA_XGRPALERT_POWERTYPES = {
	...
	[16]={text=EA_XSPECINFO_ESSENCE, value=EA_SPELL_POWER_ESSENCE},	
}
